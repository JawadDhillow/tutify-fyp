...
// Query to get total number of courses added by the logged-in user
...
<body>
  ...
  <div class="container my-3">
    ...
    <h3>Notifications</h3>
    <?php
    $user_name = $_SESSION['user_name']; // Replace with actual tutor ID
    $sql = "SELECT * FROM notifications WHERE user_name = '$user_name' ORDER BY created_at DESC";
    $result = mysqli_query($con, $sql);
    ?>
    <div class="row">
      <div class="col-sm">
